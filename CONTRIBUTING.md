# Contributing to cifmt

cifmt is a CI formatter library and CLI for pretty formatting JSON messages in CI environments. If you're interested in contributing to cifmt, hopefully, this document makes the process for contributing clear.
...
There are many ways to contribute to cifmt. Here's a few ideas to get started:

-   Look through the [open issues](https://github.com/JP-Ellis/cifmt/issues). Provide workarounds, ask for clarification, or suggest labels. Help [triage issues](#triaging-issues-and-pull-requests).
-   If you find an issue you would like to fix, [open a pull request](#pull-requests). Issues tagged as [_Good first issue_](https://github.com/JP-Ellis/cifmt/labels/good%20first%20issue) are a good place to get started.
-   Read through the [docs](https://docs.rs/cifmt). If you find anything that is confusing or can be improved, you can open a pull request to improve the documentation.
-   Take a look at the [features requested](https://github.com/JP-Ellis/cifmt/labels/feature) by others in the community and consider opening a pull request if you see something you want to work on.
...
You can start [discussions](https://github.com/JP-Ellis/cifmt/discussions) on GitHub for broader questions about the library and its development.
...
-   Suggest [labels](https://github.com/JP-Ellis/cifmt/labels) that can help categorize issues.
-   Flag issues that are stale or that should be closed.
-   Ask for test plans and review code.

## Our Development Process

cifmt uses [GitHub](https://github.com/JP-Ellis/cifmt) as its source of truth. All changes will be public from the beginning.
...
cifmt has one primary branch `main` and we use feature branches to deliver new features with pull requests. Typically, we scope the branch according to the [conventional commit](#conventional-commit-messages) categories. The more common ones are:
...
When [opening a new issue](https://github.com/JP-Ellis/cifmt/issues/new), always make sure to fill out the issue template when available. **This step is very important!** Not doing so may slow down the response. Don't take this personally if this happens, and feel free to open a new issue once you've gathered all the information required by the template.

**Please don't use the GitHub issue tracker for questions.** If you have questions about using cifmt, prefer the [Discussion pages](https://github.com/JP-Ellis/cifmt/discussions), and we will do our best to answer your questions.

### Bugs

We use [GitHub Issues](https://github.com/JP-Ellis/cifmt/issues) for our public bugs. If you would like to report a problem, take a look around and see if someone already opened an issue about it. If you are certain this is a new, unreported bug, you can submit a bug report.
...
We have a list of [beginner-friendly issues](https://github.com/JP-Ellis/cifmt/labels/good%20first%20issue) to help you get your feet wet in the cifmt codebase and familiar with our contribution process. This is a great place to get started.

Apart from the `good first issue`, it is also worth looking at the [`help wanted`](https://github.com/JP-Ellis/cifmt/labels/help%20wanted) issues. If you have specific knowledge in one domain, working on these issues can make your expertise shine.
...
2.  Clone your fork locally:
    ...
    ```bash
    git clone https://github.com/your-username/cifmt.git
    cd cifmt
    ```
...
5.  Try running the CLI to make sure it works:
...
By contributing to cifmt, you agree that your contributions will be licensed under its MIT license.
...
3.  **Return typed structs** instead of raw strings where appropriate
4.  **Handle errors gracefully** with appropriate error types
5.  **Add comprehensive documentation** with examples
6.  **Support multiple CI platforms** where applicable

## Getting Help

If you need help or have questions:

-   📚 Check the [documentation](https://docs.rs/cifmt)
-   💬 Start a [discussion](https://github.com/JP-Ellis/cifmt/discussions)
-   🐛 [Open an issue](https://github.com/JP-Ellis/cifmt/issues) for bugs
